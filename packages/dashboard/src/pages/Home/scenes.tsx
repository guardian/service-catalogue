...
export function getBasicScene(
	...
	const queryRunner = new SceneQueryRunner({
		datasource: DATASOURCE_CLOUDQUERY,
		queries: [
			{
				refId: 'A',
				datasource: DATASOURCE_CLOUDQUERY,
				rawSql:
					'select full_name, archived from github_repositories order by full_name',
				format: 'table',
			},
		],
		maxDataPoints: 100,
