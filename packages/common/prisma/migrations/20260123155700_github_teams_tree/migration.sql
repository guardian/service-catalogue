...
BEGIN TRANSACTION;
    ...
    CREATE OR REPLACE FUNCTION fn_github_organisation_tree() RETURNS TABLE (
        id          TEXT
        , type      TEXT
        , name      TEXT
        , ancestors TEXT[]
    ...
    CREATE OR REPLACE VIEW github_organisation_tree AS (
        SELECT  *
        FROM    fn_github_organisation_tree()
    );
    ...
    CREATE OR REPLACE FUNCTION fn_github_teams_tree() RETURNS TABLE (
        ...
        FROM    github_organisation_tree tree
