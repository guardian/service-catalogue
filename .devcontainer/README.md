...
## Local prerequisites and VPN-specific behaviour

This project’s dev container relies on a few host resources, so startup can fail if they are missing.

### Before opening in Dev Containers

- Docker Desktop must be running.
- Connect to the Guardian VPN if you want to run the local dev-environment.
